...
//   { name: "Frontend", color: "from-cyan-400 to-blue-500" },
//   { name: "Backend", color: "from-purple-400 to-indigo-500" },
//   { name: "Tools", color: "from-pink-400 to-rose-500" },
//   { name: "Languages", color: "from-amber-400 to-orange-500" }
// ];
...
//     <section
//       id="skills"
//       className={`${funnelSans.className} relative overflow-hidden mt-5 mb-5 rounded-xl py-20 px-6`}
//     >
...
//         >
//           <motion.h2 
//             className="text-5xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-purple-400 dark:to-cyan-400"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
...
//                   ? `bg-gradient-to-r ${category.color} text-white shadow-lg ${category.color.replace('to', 'shadow')}/30`
//                   : "bg-white/80 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
//               }`}
...
//                       <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-purple-500 dark:to-indigo-600 flex items-center justify-center text-white">
//                         {skill.charAt(0)}
//                       </div>
//                     </div>
...
//                   <motion.div 
//                     className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-purple-500 dark:to-indigo-600"
//                     initial={{ width: 0 }}
...
//               exit={{ opacity: 0, y: -20 }}
//             >
//               <span className="font-bold bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-purple-500 dark:to-indigo-600 bg-clip-text text-transparent">
//                 {skills[hoveredSkill]}
//               </span>
//             </motion.div>
//           )}
